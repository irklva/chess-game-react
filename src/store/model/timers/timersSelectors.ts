...
export const getBlackTimerMoment = (state: RootState): TimersSchema['blackTimerMoment'] => state.timers.blackTimerMoment;
export const getWhiteTimerMoment = (state: RootState): TimersSchema['whiteTimerMoment'] => state.timers.whiteTimerMoment;
